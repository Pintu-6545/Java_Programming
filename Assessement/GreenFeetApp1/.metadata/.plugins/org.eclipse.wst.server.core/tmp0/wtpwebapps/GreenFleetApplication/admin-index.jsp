...
<body>
	...
	<section class="carousel">
		<div class="slide active"
			style="background-image: url('https://images.unsplash.com/photo-1601584115197-04ecc0da31d7');">
	...
	<section class="section">
		...
		<div class="card-grid">
			...
			<div class="card">
				...
				<h3>Bike Delivery</h3>
				<p>Fast two-wheeler service.</p>
			</div>
			<div class="card">
				<img
					src="https://images.unsplash.com/photo-1502877338535-766e1452684a">
				<h3>Truck Transport</h3>
				<p>Heavy logistics.</p>
			</div>
		</div>
	</section>
	...
	<section class="form-section">
		<div class="form-wrapper">
			...
			<form class="form-box">
				...
				<div class="input-group">
					<i class="fa-solid fa-phone"></i> <input type="tel"
						placeholder="Mobile Number" required>
				</div>

				<div class="input-group">
					<i class="fa-solid fa-car-side"></i> <select required>
